...
const Actions = ({ post }) => {
	...
	const handleJoinEvent = async () => {
		...
		// 		console.log(postData.name,postData.startDate,postData.startTime,postData.ticketPrice);
		// 	} catch (error) {
		// 		throw new Error('Failed to fetch post details');
		// 	}
	};
	...
	return (
		<Flex flexDirection='column'>
			<Flex gap={3} my={2} onClick={(e) => e.preventDefault()} >
				...
				<RepostSVG />
				<ShareSVG />
				<Button colorScheme="blue" size="sm" onClick={handleJoinEvent}>Join Event</Button>
			</Flex>
